...
import models.question.DerivativeQuestionsTable
...
object UserQuestionsTable extends Table[(Long, Long)]("user_questions") {
	...
	def questionIdFK = foreignKey("user_questions_question_fk", questionId, new DerivativeQuestionsTable)(_.id, onDelete = ForeignKeyAction.Cascade)
