...
object QuizzesQuestionsTable extends Table[Quiz2Question]("derivative_quizzes_question") {
	...
	def questionSetIdFK = foreignKey("derivative_quizzes_question_quiz_fk", quizId, QuizesTable)(_.id, onDelete = ForeignKeyAction.Cascade)
}