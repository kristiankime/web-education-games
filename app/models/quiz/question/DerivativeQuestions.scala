...
object DerivativeQuestions {
  ...
  def correctResults(user: User, num: Int, questionTable: TableQuery[DerivativeQuestionsTable], answerTable: TableQuery[DerivativeAnswersTable])(implicit session: Session) = correct(user.id, questionTable, answerTable).take(num).map(e => (apply(e._1).get.results(user), e._2))
  ...
  def incorrectResults(user: User, num: Int, questionTable: TableQuery[DerivativeQuestionsTable], answerTable: TableQuery[DerivativeAnswersTable])(implicit session: Session) = incorrect(user.id, questionTable, answerTable).take(num).map(e => (apply(e._1).get.results(user), e._2))
