# Remove this comment and start using Slick DDL generation
...
create table "courses" ("id" SERIAL NOT NULL PRIMARY KEY,"name" TEXT NOT NULL,"creationDate" TIMESTAMP NOT NULL,"updateDate" TIMESTAMP NOT NULL);
...
create table "sections" ("id" SERIAL NOT NULL PRIMARY KEY,"name" TEXT NOT NULL,"courseId" BIGINT NOT NULL,"creationDate" TIMESTAMP NOT NULL,"updateDate" TIMESTAMP NOT NULL);
...
create table "derivative_questions" ("id" SERIAL NOT NULL PRIMARY KEY,"mathml" TEXT NOT NULL,"rawstr" TEXT NOT NULL,"synched" BOOLEAN NOT NULL,"creationDate" TIMESTAMP NOT NULL);
...
create table "derivative_quizzes" ("id" SERIAL NOT NULL PRIMARY KEY,"name" TEXT NOT NULL,"creationDate" TIMESTAMP NOT NULL,"upadateDate" TIMESTAMP NOT NULL);
