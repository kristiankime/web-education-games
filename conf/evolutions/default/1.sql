...
create table "derivative_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"mathml" TEXT NOT NULL,"rawstr" TEXT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"quiz_id" BIGINT,"order" INTEGER NOT NULL);
...
create table "question_id" ("question_id" SERIAL NOT NULL PRIMARY KEY);
...
create table "tangent_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"function" TEXT NOT NULL,"function_str" TEXT NOT NULL,"at_point_x" TEXT NOT NULL,"at_point_x_str" TEXT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"quiz_id" BIGINT,"order" INTEGER NOT NULL);
...
alter table "tangent_questions" add constraint "tangent_questions__id_fk" foreign key("id") references "question_id"("question_id") on update NO ACTION on delete CASCADE;
