...
create table "quizzes_2_derivative_questions" ("quiz_id" BIGINT NOT NULL,"question_id" BIGINT NOT NULL,"order" INTEGER NOT NULL);
alter table "quizzes_2_derivative_questions" add constraint "derivative_quizzes_2_questions_pk" primary key("question_id","quiz_id");
...
alter table "quizzes_2_derivative_questions" add constraint "derivative_quizzes_2_questions_question_fk" foreign key("question_id") references "derivative_questions"("id") on update NO ACTION on delete CASCADE;
alter table "quizzes_2_derivative_questions" add constraint "derivative_quizzes_2_questions_quiz_fk" foreign key("quiz_id") references "derivative_quizzes"("id") on update NO ACTION on delete CASCADE;
...
alter table "quizzes_2_derivative_questions" drop constraint "derivative_quizzes_2_questions_question_fk";
alter table "quizzes_2_derivative_questions" drop constraint "derivative_quizzes_2_questions_quiz_fk";
...
alter table "quizzes_2_derivative_questions" drop constraint "derivative_quizzes_2_questions_pk";
drop table "quizzes_2_derivative_questions";
