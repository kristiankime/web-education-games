...
create table "derivative_graph_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"mathml" TEXT NOT NULL,"rawstr" TEXT NOT NULL,"show_function" BOOLEAN NOT NULL,"creation_date" TIMESTAMP NOT NULL,"derivativeOrder" TEXT NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"order" INTEGER NOT NULL);
...
create table "derivative_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"mathml" TEXT NOT NULL,"rawstr" TEXT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"order" INTEGER NOT NULL);
...
create table "multiple_choice_question_options" ("id" SERIAL NOT NULL PRIMARY KEY,"question_id" BIGINT NOT NULL,"option_raw" TEXT NOT NULL,"option_html" TEXT NOT NULL);
create table "multiple_choice_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"description" TEXT NOT NULL,"explanation_raw" TEXT NOT NULL,"explanation_html" TEXT NOT NULL,"correct_answer" SMALLINT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"order" INTEGER NOT NULL);
...
create table "multiple_function_question_options" ("id" SERIAL NOT NULL PRIMARY KEY,"question_id" BIGINT NOT NULL,"option_raw" TEXT NOT NULL,"option_html" TEXT NOT NULL,"mathml" TEXT NOT NULL,"rawstr" TEXT NOT NULL);
create table "multiple_function_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"description" TEXT NOT NULL,"explanation_raw" TEXT NOT NULL,"explanation_html" TEXT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"order" INTEGER NOT NULL);
...
create table "polynomial_zone_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"roots" TEXT NOT NULL,"scale" DOUBLE PRECISION NOT NULL,"zone_type" SMALLINT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"order" INTEGER NOT NULL);
...
create table "tangent_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"function" TEXT NOT NULL,"function_str" TEXT NOT NULL,"at_point_x" TEXT NOT NULL,"at_point_x_str" TEXT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"order" INTEGER NOT NULL);
