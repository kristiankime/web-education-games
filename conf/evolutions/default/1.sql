...
create table "derivative_questions" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"mathml" VARCHAR NOT NULL,"rawstr" VARCHAR NOT NULL,"creation_date" TIMESTAMP NOT NULL,"quiz_id" BIGINT,"order" INTEGER NOT NULL);
