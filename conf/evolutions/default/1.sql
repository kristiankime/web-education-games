...
create table "multiple_choice_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"explanation" TEXT NOT NULL,"correct_answer" SMALLINT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"quiz_id" BIGINT,"order" INTEGER NOT NULL);
...
create table "multiple_function_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"explanation" TEXT NOT NULL,"creation_date" TIMESTAMP NOT NULL,"at_creation_difficulty" DOUBLE PRECISION NOT NULL,"quiz_id" BIGINT,"order" INTEGER NOT NULL);
