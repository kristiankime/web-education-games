...
create table "tangent_answers" ("id" SERIAL NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"question_id" BIGINT NOT NULL,"slope_mathml" TEXT NOT NULL,"slope_rawstr" TEXT NOT NULL,"intercept_mathml" TEXT NOT NULL,"intercept_rawstr" TEXT NOT NULL,"correct" SMALLINT NOT NULL,"creation_date" TIMESTAMP NOT NULL);
