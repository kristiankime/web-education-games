...
create table "derivative_assignment_groups_quizzes" ("group_id" BIGINT NOT NULL,"quiz_id" BIGINT NOT NULL);
alter table "derivative_assignment_groups_quizzes" add constraint "derivative_assignment_groups_quizzes_pk" primary key("group_id","quiz_id");
...
alter table "derivative_assignment_groups_quizzes" add constraint "derivative_assignment_groups_quizzes_course_fk" foreign key("group_id") references "assignment_groups"("id") on update NO ACTION on delete CASCADE;
alter table "derivative_assignment_groups_quizzes" add constraint "derivative_assignment_groups_quizzes_quiz_fk" foreign key("quiz_id") references "derivative_quizzes"("id") on update NO ACTION on delete CASCADE;
...
alter table "derivative_assignment_groups_quizzes" drop constraint "derivative_assignment_groups_quizzes_course_fk";
alter table "derivative_assignment_groups_quizzes" drop constraint "derivative_assignment_groups_quizzes_quiz_fk";
...
alter table "derivative_assignment_groups_quizzes" drop constraint "derivative_assignment_groups_quizzes_pk";
drop table "derivative_assignment_groups_quizzes";
