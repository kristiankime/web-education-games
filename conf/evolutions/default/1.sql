...
create table "assignment_groups" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"sectionId" BIGINT NOT NULL,"assignmentId" BIGINT NOT NULL,"creationDate" TIMESTAMP NOT NULL,"updateDate" TIMESTAMP NOT NULL);
create table "assignments" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"courseId" BIGINT NOT NULL,"owner" BIGINT NOT NULL,"creationDate" TIMESTAMP NOT NULL,"updateDate" TIMESTAMP NOT NULL,"startDate" TIMESTAMP,"endDate" TIMESTAMP);
...
create table "derivative_question_for" ("group_id" BIGINT NOT NULL,"question_id" BIGINT NOT NULL,"user_id" BIGINT NOT NULL);
alter table "derivative_question_for" add constraint "derivative_question_for_pk" primary key("group_id","question_id","user_id");
create table "derivative_questions" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"mathml" VARCHAR NOT NULL,"rawstr" VARCHAR NOT NULL,"creationDate" TIMESTAMP NOT NULL);
create table "derivative_quizzes" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"name" VARCHAR NOT NULL,"creationDate" TIMESTAMP NOT NULL,"upadateDate" TIMESTAMP NOT NULL);
...
alter table "derivative_question_for" add constraint "derivative_question_for_group_fk" foreign key("group_id") references "assignment_groups"("id") on update NO ACTION on delete CASCADE;
...
alter table "derivative_question_for" drop constraint "derivative_question_for_group_fk";
