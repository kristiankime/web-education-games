...
alter table "multiple_choice_answers" add constraint "multiple_choice_answers__question_fk" foreign key("question_id") references "graph_match_questions"("id") on update NO ACTION on delete CASCADE;
