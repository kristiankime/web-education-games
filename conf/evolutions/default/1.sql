...
create table "tangent_questions" ("id" BIGINT NOT NULL PRIMARY KEY,"owner" BIGINT NOT NULL,"function" VARCHAR NOT NULL,"function_str" VARCHAR NOT NULL,"at_point_x" VARCHAR NOT NULL,"at_point_x_str" VARCHAR NOT NULL,"creation_date" TIMESTAMP NOT NULL,"quiz_id" BIGINT,"order" INTEGER NOT NULL);
