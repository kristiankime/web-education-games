...
create table "games" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"request_date" TIMESTAMP NOT NULL,"requestor" BIGINT NOT NULL,"requestee" BIGINT NOT NULL,"request_accepted" BOOLEAN NOT NULL,"course" BIGINT,"requestor_quiz" BIGINT,"requestee_quiz" BIGINT,"requestee_finished" BOOLEAN NOT NULL,"requestor_finished" BOOLEAN NOT NULL,"finished_date" TIMESTAMP);
