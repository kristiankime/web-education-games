...
create table "derivative_quizzes_question" ("quiz_id" BIGINT NOT NULL,"question_id" BIGINT NOT NULL);
alter table "derivative_quizzes_question" add constraint "derivative_quizzes_question_pk" primary key("question_id","quiz_id");
...
alter table "derivative_quizzes_question" add constraint "derivative_quizzes_question_question_fk" foreign key("question_id") references "derivative_questions"("id") on update NO ACTION on delete CASCADE;
alter table "derivative_quizzes_question" add constraint "derivative_quizzes_question_quiz_fk" foreign key("quiz_id") references "derivative_quizes"("id") on update NO ACTION on delete CASCADE;
...
alter table "derivative_users_quizzes" add constraint "derivative_users_quizzes_quiz_fk" foreign key("quiz_id") references "derivative_quizes"("id") on update NO ACTION on delete CASCADE;

# --- !Downs

alter table "derivative_answers" drop constraint "derivative_answers_fk";
alter table "derivative_quizzes_question" drop constraint "derivative_quizzes_question_question_fk";
alter table "derivative_quizzes_question" drop constraint "derivative_quizzes_question_quiz_fk";
...
alter table "derivative_quizzes_question" drop constraint "derivative_quizzes_question_pk";
drop table "derivative_quizzes_question";
