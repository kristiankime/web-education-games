...
create table "derivative_users_quiz" ("user_id" BIGINT NOT NULL,"quiz_id" BIGINT NOT NULL);
alter table "derivative_users_quiz" add constraint "derivative_users_quiz_pk" primary key("user_id","quiz_id");
...
alter table "derivative_users_quiz" add constraint "derivative_users_quiz_user_fk" foreign key("user_id") references "user"("id") on update NO ACTION on delete CASCADE;
alter table "derivative_users_quiz" add constraint "derivative_users_quiz_quiz_fk" foreign key("quiz_id") references "derivative_quizes"("id") on update NO ACTION on delete CASCADE;
...
alter table "derivative_users_quiz" drop constraint "derivative_users_quiz_user_fk";
alter table "derivative_users_quiz" drop constraint "derivative_users_quiz_quiz_fk";
...
alter table "derivative_users_quiz" drop constraint "derivative_users_quiz_pk";
drop table "derivative_users_quiz";
drop table "token";
drop table "user";
